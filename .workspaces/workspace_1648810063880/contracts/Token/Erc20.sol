...
// File interfaces/dforce/Token.sol
...
contract MockERC20 is ERC20, dERC20 {
    ...
    function mint(address account, uint256 total) external override {
        _mint(account, total);
    }

    function redeem(address account, uint256 amount) external override {}

    function getTokenBalance(address account) external view override returns (uint256) {
        return 0;
    }
